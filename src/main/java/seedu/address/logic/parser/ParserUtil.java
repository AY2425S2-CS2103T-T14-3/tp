...
public class ParserUtil {
    ...
    /**
     * Parses a {@code String emailId} into an {@code EmailId}.
     * Leading and trailing whitespaces will be trimmed.
     *
     * @throws ParseException if the given {@code emailId} is invalid.
     */
    public static EmailId parseEmailId(String emailId) throws ParseException {
