...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS,
                        PREFIX_EMAIL, PREFIX_STUDENT_ID));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + VALID_STUDENT_ID_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_STUDENT_ID_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB,
                expectedMessage);
    }
