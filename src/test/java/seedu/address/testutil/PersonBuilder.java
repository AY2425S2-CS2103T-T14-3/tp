...
public class PersonBuilder {
    ...
    public PersonBuilder(Person personToCopy) {
        ...
        emailId = personToCopy.getEmailId();
    ...
    /**
     * Sets the {@code EmailId} of the {@code Person} that we are building.
     */
    public PersonBuilder withEmail(String emailId) {
        this.emailId = new EmailId(emailId);
        return this;
    }

    public Person build() {
        return new Person(name, studentId, emailId, address, tags);
    }
